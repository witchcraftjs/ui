...
type Story = StoryObj<typeof LibCombobox> & { args?: ExtraTestArgs }
		...
		return {
			...
			<div class="flex flex-col gap-3">
				<div class="flex flex-col gap-1">
					<lib-checkbox v-model="simulateLoading">Simulate Loading</lib-checkbox>
					<lib-checkbox v-model="loading">Loading (Force State)</lib-checkbox>
				</div>
