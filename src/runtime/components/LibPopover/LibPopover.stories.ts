...
import LibPopover from "./LibPopover.vue"
...
const meta: Meta<typeof LibPopover> = {
	component: LibPopover,
...
export default meta
type Story = StoryObj<typeof LibPopover> & { args?: ExtraTestArgs }
		...
		return {
			...
			>
				...
				>
					...
					<lib-popover v-model="value" v-bind="{
						...args,
						...
						<template #button>
							<lib-button :style="buttonStyle" @click="value = !value" >Toggle Popover</lib-button>
						</template>
						<template #popover>
								<lib-debug
