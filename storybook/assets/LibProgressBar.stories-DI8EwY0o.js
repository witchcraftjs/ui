import{r as g,b as c}from"./vue.esm-bundler-Cma5tyk0.js";import{o as p,c as i}from"./index-DLnQEDO-.js";import"./LibRoot-DSIPGJTr.js";import"./iframe-DJ8xJpys.js";import"./twMerge-CudCRF6p.js";const L={component:p,title:"Components/ProgressBar",args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:r=>({components:i,setup:()=>{const a=g(r._start);if(r.progress)a.value=r.progress;else{const l=setInterval(()=>{a.value>=100?a.value=0:a.value+=r._add},r._timeout);c(()=>{clearInterval(l)})}return{args:{...r},progress:a}},template:`
