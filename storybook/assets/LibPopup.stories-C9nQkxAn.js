import{r as c,c as b,w as h}from"./vue.esm-bundler-B4I_ujvT.js";import{n as x,c as v}from"./index-CPjZL_cd.js";import{v as P}from"./LibRoot-WN0KOPQ5.js";import"./twMerge-CudCRF6p.js";import"./iframe-DFGok_fB.js";const S={component:x,title:"Components/Popup",args:{}},e={render:g=>({components:v,directives:{extractRootEl:P},setup:()=>{const p=c(!1),u=["TL","TC","TR","BL","BC","BR"],t=c("TL"),d=c(!0),m=b(()=>{switch(t.value){case"TL":return"align-self: flex-start; justify-self: flex-start;";case"TC":return"align-self: flex-start; justify-self: center;";case"TR":return"align-self: flex-start; justify-self: flex-end;";case"BL":return"align-self: flex-end; justify-self: flex-start;";case"BC":return"align-self: flex-end; justify-self: center;";case"BR":return"align-self: flex-end; justify-self: flex-end;";default:return""}});return h(p,()=>{if(!p.value&&d.value){const f=u.indexOf(t.value);f<5?t.value=u[f+1]:t.value=u[0]}}),{args:g,buttonPos:t,autoRotatePos:d,buttonStyle:m,value:p}},template:`
            <lib-simple-input
