import{r as g,a as c}from"./vue.esm-bundler-C1bW2l80.js";import{d as p}from"./LibRoot-D-jXU3dI.js";import{c as i}from"./index-B_igWmnV.js";import"./iframe-l0xL2FWv.js";import"./twMerge-CudCRF6p.js";const L={component:p,title:"Components/ProgressBar",args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:r=>({components:i,setup:()=>{const a=g(r._start);if(r.progress)a.value=r.progress;else{const l=setInterval(()=>{a.value>=100?a.value=0:a.value+=r._add},r._timeout);c(()=>{clearInterval(l)})}return{args:{...r},progress:a}},template:`
