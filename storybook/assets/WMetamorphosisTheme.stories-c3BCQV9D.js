import{a as n,U as e,h as d,j as v,q as w}from"./WRoot-BpJCm3EK.js";import{y as p,ae as f,S as m}from"./vue.esm-bundler-AO_tuUZ6.js";import{dR as b,eK as c}from"./index-DpJYLACx.js";import"./iframe-D0W54ZZL.js";import"./twMerge-CaMoglCM.js";const S={component:b,title:"Components/MetamorphosisTheme",args:{}},s={tags:["skip-smoke-test"],render:o=>{const i=o;return{components:c,setup(){return{args:i,theme:p(w)}},template:`
        ...
        `}},args:{options:{forceDisplayStopHandles:!0}}},a={render:o=>{const i=o;return{components:c,setup(){const u=new n(e.px,20),g=new d("gradient",e.rgb,[new n(e.rgb,{r:255,g:50,b:50}),new n(e.rgb,{r:50,g:100,b:255}),new n(e.rgb,{r:50,g:255,b:100})],[0,.5,1]),h=new d("spacing",e.px,[new n(e.px,{_:0}),new n(e.px,{_:8}),new n(e.px,{_:16})],[0,.3,1]),r=p(new v({radius:u,gradient:g,spacing:h})),t=m(null);f(t,()=>{t.value?r.attach(t.value):r.detach()});const l=m(JSON.stringify(r.css,null,"	"));return r.on("change",()=>{l.value=JSON.stringify(r.css,null,"	")}),{args:i,css:l,dummyEl:t,theme:r}},template:`
            <div class="flex flex-col gap-4 w-full max-w-xl">
                <WMetamorphosisTheme v-bind="{
                    ...args,
                    theme
