import{$ as p,d as f,c as b,e as v,f as D,g as h,h as T}from"./index-D2G9LM0b.js";import{r as u,c as P}from"./vue.esm-bundler-BHVC7zIi.js";import"./LibRoot-CoN-ifen.js";import"./iframe-BSTD6wzt.js";import"./twMerge-CudCRF6p.js";function y(t,...n){return String.raw(t,...n)}const k={component:f,title:"Components/DatePicker",args:{slot:"",timeZone:p()}};function m(t,n){return h(T(t,n),"UTC").toAbsoluteString()}const e={render:t=>({components:{...b},setup:()=>{const n=u(t.modelValue),l=u(t.timeZone),g=P(()=>{const a=n.value,c=l.value;return a instanceof Date?m(a,c):typeof a=="object"?`Start: ${a.start?m(a.start,c):"undefined"}, End: ${a.end?m(a.end,c):"undefined"}`:"undefined"});return{args:t,getLocalTimeZone:p,modelValue:n,timeZone:l,debugUtcDate:g}},template:`
