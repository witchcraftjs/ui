import{r as n,d as m}from"./vue.esm-bundler-B4I_ujvT.js";import{c as p,a as u}from"./storybook-BVdxu6-X.js";import{p as g,c as b}from"./index-CPjZL_cd.js";import"./LibRoot-WN0KOPQ5.js";import"./iframe-DFGok_fB.js";import"./twMerge-CudCRF6p.js";const R={component:g,title:"Components/Recorder",args:{label:"Some Label",recordingTitle:"Recording. Press enter or click away to accept. Press escape to cancel.",modelValue:"K E Y S"},parameters:{docs:{description:{component:`This is a special input component designed to record any type of event.
...
This basic implementation just lists the keys. Enter accepts the recording, escape cancels back to the initial value.`}}}},e={render:d=>({components:b,setup:()=>{const c=n(!1),t=n(""),s=n(d.modelValue),i=n(null),l=p(t,c,s,i);return m(u(t,c,s)),{args:d,modelValue:s,recorder:l,recording:c,recordingValue:t,recorderEl:i}},template:`
            <lib-recorder
                v-bind="args"
