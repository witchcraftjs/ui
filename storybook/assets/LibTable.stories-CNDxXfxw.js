import{f as n}from"./chunk-3WUZ46N3-CXZkDYP_.js";import{r as y,d as C}from"./vue.esm-bundler-D4Wb0Q-q.js";import{s as _,c as v}from"./index-DRBPq8mz.js";import"./LibRoot-DKpgBW2I.js";import"./iframe-B3RJqWWC.js";import"./twMerge-BZGhTDWl.js";const P=Array.from({length:100}).fill(0).map(a=>n.lorem.sentence(n.number.int({min:1,max:50}))),$={component:_,title:"Components/Table"},e={render:a=>({components:v,setup:()=>{const r=y(!0),I=y(!1);return{args:C({...a,resizable:{enabled:!0,...a.resizable}}),debugGrips:I,show:r}},template:`
        ...
        `}},u={...e,args:{...e.args,resizable:{fitWidth:!1}}},b={...e,args:{...e.args,resizable:{enabled:!0},stickyHeader:!0,wrapperClass:`
            max-h-[50dvh]
        `,values:Array.from({length:200}).fill(0).map((a,r)=>({prop1:`Item${r+1} Prop 1`,prop2:`Item${r+1} Prop 2`,prop3:`Item${r+1} Prop 3`}))}},s={...e,args:{...e.args,resizable:{enabled:!0},virtualizerOptions:{enabled:!0},stickyHeader:!0,wrapperClass:`
            max-h-[50dvh]
