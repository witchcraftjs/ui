import{r as g,b as c}from"./vue.esm-bundler-B4I_ujvT.js";import{o as p,c as i}from"./index-CPjZL_cd.js";import"./LibRoot-WN0KOPQ5.js";import"./iframe-DFGok_fB.js";import"./twMerge-CudCRF6p.js";const L={component:p,title:"Components/ProgressBar",args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:r=>({components:i,setup:()=>{const a=g(r._start);if(r.progress)a.value=r.progress;else{const l=setInterval(()=>{a.value>=100?a.value=0:a.value+=r._add},r._timeout);c(()=>{clearInterval(l)})}return{args:{...r},progress:a}},template:`
