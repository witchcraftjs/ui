import{r as o,c as b,o as S}from"./vue.esm-bundler-BHVC7zIi.js";import{r as g,c as V}from"./index-D2G9LM0b.js";import"./LibRoot-CoN-ifen.js";import"./iframe-BSTD6wzt.js";import"./twMerge-CudCRF6p.js";const H={component:g,title:"Components/Suggestions",args:{id:"some-id",modelValue:"",label:"Some Label",border:!0,suggestions:["A","AB","ABC","B","BC","C","ABCDEFGHIJKLMNOPQRSTUVWXYZ"]}},e={render:s=>({components:{...V,LibSuggestions:g},setup:()=>{const t=o(s.modelValue),d=o(s.modelValue),n=o(null),m=u=>{n.value?.inputKeydownHandler(u)},p=b(()=>n.value?.suggestions),c=u=>{n.value?.inputBlurHandler(u)};return S(()=>{n.value?.suggestions.open()}),{args:s,inputValue:t,modelValue:d,isOpen:o(!1),suggestions:p,drawer:n,keydownHandler:m,blurHandler:c}},template:`
