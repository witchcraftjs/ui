...
import { type BaseInteractiveProps, type LabelProps, type LinkableByIdProps, type MultiValueProps, type SuggestionsEmits, type SuggestionsProps, type WrapperProps } from "../shared/props.js";
type WrapperTypes = Partial<WrapperProps<"item", HTMLAttributes, {
    /** Tailwind classes. */
    class?: string;
}>>;
type RealProps = LinkableByIdProps & LabelProps & BaseInteractiveProps & MultiValueProps & {
...
declare const _default: <TSuggestion extends string | object>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_expose?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
    props: __VLS_PrettifyLocal<Pick<Partial<{}> & Omit<{
        readonly onSubmit?: ((val: string, suggestion?: any) => any) | undefined;
    ...
    } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, never>, "onSubmit" | "onUpdate:modelValue" | "onUpdate:isOpen" | "onUpdate:activeSuggestion" | "onUpdate:inputValue"> & (Props & SuggestionsProps<TSuggestion> & {
        /**
    ...
    emit: SuggestionsEmits & (((evt: "update:modelValue", value: string) => void) & ((evt: "update:inputValue", value: string) => void));
}>) => import("vue").VNode & {
